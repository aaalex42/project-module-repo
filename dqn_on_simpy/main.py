...
def main():
    ...
    agent = DQNAgent(env, device='cuda', num_episodes=50, BATCH_SIZE=10000, GAMMA=0.99, EPS_START=0.9, EPS_END=0.05, EPS_DECAY=1000, TAU=0.005, LR=1e-5)

    total_rewards, inventory_levels, _ = agent.train(num_episodes=50)
