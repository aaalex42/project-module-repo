...
args.hidden_layer_list = [64, 128, 128, 32]  # hidden layers for actor and critic
...
args.train_iter = 1_000_000                # train iters each time step
args.validate_steps =  25_000              # CHECK THIS how many steps to perform a validate experiment 
args.seed = -1                          # seed
