...
args.hidden_layer_list = [64,128]       # hidden layers for actor and critic
args.init_w = 3e-3                      # weight initialization
args.lr_actor = 0.00025                 # learning rate for actor
args.lr_critic = 1e-3                   # learning rate for critic
args.memory_size = 100_000              # memory size
...
args.validate_episodes = 500            # CHECK THIS how many episode to perform during validate experiment
args.max_episode_length = 1000          # maximum episode length
args.output = 'output'                  # output directory
args.debug = True                       # debug mode
args.train_iter = 100                 # train iters each time step
args.validate_steps =  100          # CHECK THIS how many steps to perform a validate experiment 
args.seed = -1                          # seed
