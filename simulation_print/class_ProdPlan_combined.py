...
demand_p1 = Demand(p1, RBASE, DAYS_FC)
inventory_p1 = Inventory(p1)
...
machine.plan()
machine.plan()
machine.plan()""" #if we do not produce anything, planning will not result in something

machine.plan()
machine.produce()

print("=====AFTER PLANNING AND PRODUCING")
printfunc_prodplan(machine)
printfunc_demand(demand_p1)
printfunc_inv(inventory_p1)