...
def main():
    ...
    agent = DQNAgent(skip_env, device='cuda', num_episodes=250, BATCH_SIZE=32, BATCH_START_SIZE=10000, MEMORY_SIZE=100000, GAMMA=0.99, EPS_START=0.9, EPS_END=0.02, EPS_DECAY=1000000, TAU=0.005, LR=1e-5)
